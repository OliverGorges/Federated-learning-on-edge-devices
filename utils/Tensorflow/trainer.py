...
def readEval(evalDir, tags = ['DetectionBoxes_Percision/mAP', 'DetectionBoxes_Recall/AR@1', 'loss', 'Loss/classification_loss', 'Loss/localization_loss', 'Loss/regularization_loss', 'Loss/total_loss']):
    meta = {}    
